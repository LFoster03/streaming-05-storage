"""src/streaming/kafka_consumer_foster.py.
...
OBS:
  ...
  Copy it, rename it kafka_consumer_foster.py, and modify your copy.
"""
...
from streaming.data_validation.data_contract_foster import (
    CONSUMED_FIELDNAMES,
    SALES_REQUIRED_FIELDS,
    validate_required_fields,
)
from streaming.storage.storage_foster import init_db, write_valid_record
...
OUTPUT_CSV: Final[Path] = OUTPUT_DIR / "consumed_sales_foster.csv"
...
def load_reference_data() -> tuple[dict[str, float], dict[str, float]]:
    ...
    Returns:
        A tuple of (region_lookup, currency_lookup).
    """
...
def process_message(
    ...
    *,
    ...
    Arguments:
        ...
        currency_lookup: Exchange rates to USD by currency_code.
    ...
    enriched = enrich_message(row, region_lookup, currency_lookup)
